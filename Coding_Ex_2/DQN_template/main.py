    ...
    def runDQN(self, agent, no_episodes, training=False):
        ...
        for episode in range(no_episodes):
            ...
            for t in range(self.max_timesteps):
                #TODO: Define the main DQN loop here (see page 17 of DQN lecture). The observation of a transition is
...
class DQN_Agent:
    ...
    # TODO: Define the function to update weights of your network (see page 17 of lecture on DQN)
